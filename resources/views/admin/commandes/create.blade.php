...
@section('title', 'Nouvelle commande - POWERSTOCK')
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-secondary">Ajouter une commande client</p>
            </div>
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        <form action="{{ route('admin.commandes.store') }}" method="POST" id="commandeForm">
            @csrf
            ...
            <div id="produits-container">
                <div class="row produit-row mb-3">
                    ...
                    <div class="col-md-3">
                        <input type="number" name="produits[0][qty]" class="form-control quantite-input" value="1" min="1" required>
                    </div>
                    <div class="col-md-3">
                        <input type="text" class="form-control total-ligne bg-light" readonly value="0 FCFA">
                    </div>
                    <div class="col-md-1">
                        <button type="button" class="btn btn-danger remove-produit" style="display: none;">🗑️</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card bg-light">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <span id="total-general" class="fw-bold fs-5">0 FCFA</span>
                            </div>
                        </div>
                    </div>
                </div>
